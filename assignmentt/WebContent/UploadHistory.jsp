...
<script src="assets/javascripts/forms/uploadHistory.js"></script>
<script src="assets/javascripts/forms/dateTime.js"></script>

</head>
<body onload=fetchUploadHistoryDetails();>
	<section class="body">
		...
		<div class="inner-wrapper">
			...
			<section role="main" class="content-body">
				<header class="page-header">
					<h2 align="center">Uploaded History</h2>
								...
								<div class="col-sm-12 col-md-12">
									...
									<div class="table-responsive">
										<table
											...
											role="grid" aria-describedby="datatable-ajax_info">
											<thead>
												<tr role="row" align="center">

													<th align="center" width="20%" class="sorting_asc"
														tabindex="0" aria-controls="datatable-ajax" rowspan="1"
														colspan="1" aria-sort="ascending"
														aria-label="Rendering engine: activate to sort column ascending"
														style="width: 10px;">Course</th>
													<th width="25%" class="sorting" tabindex="0"
														aria-controls="datatable-ajax" rowspan="1" colspan="1"
														aria-label="Browser: activate to sort column ascending"
														style="width: 10px;">Topic</th>
													<th width="15%" class="sorting" tabindex="0"
														aria-controls="datatable-ajax" rowspan="1" colspan="1"
														aria-label="Engine version: activate to sort column ascending"
														style="width: 10px;">Deadline</th>
													<th width="15%" class="sorting" tabindex="0"
														aria-controls="datatable-ajax" rowspan="1" colspan="1"
														aria-label="CSS grade: activate to sort column ascending">UploadType</th>
													<th width="15%" class="sorting" tabindex="0"
														aria-controls="datatable-ajax" rowspan="1" colspan="1"
														aria-label="CSS grade: activate to sort column ascending">PinNo</th>
													<th width="25%" class="sorting" tabindex="0"
														aria-controls="datatable-ajax" rowspan="1" colspan="1"
														aria-label="Platform(s): activate to sort column ascending"
														style="width: 20px;">Assignees</th>
												</tr>
											</thead>
											<tbody>
												<tr>
