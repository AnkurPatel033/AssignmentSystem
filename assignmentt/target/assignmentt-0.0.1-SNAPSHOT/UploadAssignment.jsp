		...
		<div class="header">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<ol class="breadcrumbs">
							<li>
								<a href=""><span class="separator"></span>
									<i class="fa ">  Last updated:21/05/2019 10:45 am</i>
								</a>
							</li>
						</ol>
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><a href="StudentHome.jsp">Submit</a></li>
					...
					<!-- start: page -->
					<div style="padding: 2%; quotes: inherit;font-family: Georgia, 'Times New Roman', Times, serif; line-break: normal">
						

						
						</div>
						<div>
						<img src="assets/images/advantages.jpg" class="rounded img-responsive" alt="John Doe">
						</div>
			</div>
